    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navController.addOnDestinationChangedListener((controller, destination, arguments) -> {
            ...
            if (destination.getId() == R.id.AfterCamera || destination.getId() == R.id.SignupFragment
                    ...
                    || destination.getId() == R.id.ResetPasswordFragment || destination.getId() == R.id.usernameChangeFragment
                    || destination.getId() == R.id.passwordChangeFragment || destination.getId() == R.id.emailChangeFragment
